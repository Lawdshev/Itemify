    ...
    <div className='flex flex-col md:h-[602px] mx-auto bg-[#E9AD11] text-[#FFFFFF] overflow-x-hidden '>
        ...
        <div className=' mx-auto flex flex-wrap h-[60%] pl-[5%] py-4 md:px-8 lg:px-0 xl:px-8 md:py-8 lg:py-4 lg:w-[90%] 5xl:w-[80%]'>
          ...
          <div className='flex flex-col h-[29%] lg:w-1/4 w-1/2 md:w-[36%] md:h-[46%] lg:h-[53%] justify-between lg:pl-8 md:pl-4'>
              <h1 className='text-[#FFFFFF] text-[12px] leading-[20px] md:text-[14px] lg:text-[16px] font-bold lg:leading-[24px] h-[25%] md:h-[20%] font-inter 3xl:text-[24px] 3xl:leading-[28px] 5xl:text-[30px] 5xl:leading-[32px]'>Abuja Office</h1>
          ...
          <div className='md:ml-[2%] lg:ml-[0] before:flex flex-col h-[18%] lg:w-[30%] w-4/5 md:w-[33%] lg:mt-4 lg:h-[40%] md:h-[33%] justify-between  md:mt-4 xl:pl-4 text-[#FFFFFF]'>
              <h1 className='text-[#FFFFFF] text-[12px] leading-[20px] md:text-[14px] lg:text-[16px] font-bold lg:leading-[24px] h-[25%] md:h-[20%] font-inter 3xl:text-[24px] 3xl:leading-[28px]'>Sierra Leone Office</h1>
              <div className='font-medium text-[#FFFFFF] text-[9px] mt-[2%] leading-[15px] md:text-[12px] lg:text-[14px] md:leading-[21px] font-inter 3xl:text-[17px] 3xl:leading-[22px] 5xl:text-[18px] '>
        ...
        <div className={`${styles.footer} flex pl-[8%] py-8 5xl:pl-[10%] h-[98px]`}>
