...
function NewsCard({img}) {
  return (
    <div className={`${styles.newsCard} w-4/5 m-7 lg:m-0 mx-auto md:mx-0 md:w-[334px]  2xl:w-[25%] h-[448px] 2xl:h-auto  flex flex-col justify-between bg-[#FFFFFF]`}>
        ...
        <p className='px-7 2xl:px-14 text-center text-[15px] leading-[25px] 2xl:mb-[5vh] 2xl:mt-[3vh] text-[#111111BF] w-full self-center 2xl:text-[24px] 2xl:leading-[32px] 4xl:text-[24px] 5xl:text-[30px] 4xl:leading-[38px]'>Lorem Ipsum is simply dummy text of the printing and type setting industry. Lorem Ipsum has been the dummy text ever</p>
